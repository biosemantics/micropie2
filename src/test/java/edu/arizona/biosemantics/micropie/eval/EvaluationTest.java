...
public class EvaluationTest {
	...
	public static void main(String[] args){
		...
		String charValEvalResultFile = "F:/MicroPIE/2017tasks/results/charValEvalResult.csv";
		String charAllEvalResultFile = "F:/MicroPIE/2017tasks/results/charAllEvalResult.csv";
		String taxonEvalResultFile = "F:/MicroPIE/2017tasks/results/taxonEvalResult.csv";
		String matrixEvalResultFile = "F:/MicroPIE/2017tasks/results/matrixEvalResult.csv";
		...
		*/
		...
		String gstMatrixFile ="F:/MicroPIE/2017tasks/GSM v2/GSM_v2_evaluation.csv";
		//gstMatrixFile
