...
public class OrganicCompoundExtractorTest {
	...
	public static void main(String[] args){
		...
		*/
		...
		String lineFile = "F:/MicroPIE/micropieInput/sentences/9.1 Organic compounds used simple.txt";
		//STEP 1: split sentences
		List<RawSentence> testSentences = sentBatPIEProcessor.createSentencesByLine(lineFile);
		...
		OrganicCompoundExtractor extractor = new OrganicCompoundExtractor(Label.c54, "Organic compounds used", null, null);
		...
		((OrganicCompoundExtractor) extractor).setPhraseRelationParser(new RelationParser());
		extractor.readKeywords("F:\\MicroPIE\\micropieInput\\CharacterValueExtractors\\c53.organic compounds used or hydrolyzed.key");
		PostProcessor postProcessor = new PostProcessor();
		for (RawSentence testSentence : testSentences) {
			Set prediction = new HashSet();
			prediction.add(Label.c54);
