...
public class InorganicCompoundExtractorTest {
	...
	public static void main(String[] args){
		...
		*/
		...
		String lineFile = "F:/MicroPIE/micropieInput/sentences/9.3 inorganic compounds used simple.txt";
		//STEP 1: split sentences
		List<RawSentence> testSentences = sentBatPIEProcessor.createSentencesByLine(lineFile);
		...
		InorganicSubstanceExtractor extractor = new InorganicSubstanceExtractor(Label.c56, "Organic compounds used", null, null);
		extractor.setPhraseParser(phraseParser);
		extractor.setPosTagger(postagger);
		extractor.readKeywords("F:\\MicroPIE\\micropieInput\\CharacterValueExtractors\\c55.inorganic substances used.key");
		PostProcessor postProcessor = new PostProcessor();
		for (RawSentence testSentence : testSentences) {
			Set prediction = new HashSet();
			prediction.add(Label.c56);
