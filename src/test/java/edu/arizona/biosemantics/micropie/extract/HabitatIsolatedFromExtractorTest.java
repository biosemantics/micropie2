...
public class HabitatIsolatedFromExtractorTest {
	...
	public static void main(String[] args){
		...
		String lineFile = "C:/micropie/sentences/3.1 Habitant Isolated From Small.txt";// Small
		...
		extractor.readKeywords("C:\\micropie\\micropie0.2_model\\CharacterValueExtractors\\c17.Habitat isolated from.key");
