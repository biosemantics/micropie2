...
public class CellShapeExtractorTest {
	...
	public static void main(String[] args){
		...
		*/
		...
		String lineFile = "F:/MicroPIE/micropieInput/sentences/2.1 Cell Shape small.txt";
		//STEP 1: split sentences
		List<RawSentence> testSentences = sentBatPIEProcessor.createSentencesByLine(lineFile);
		...
		extractor.readKeywords("F:\\MicroPIE\\micropieInput\\CharacterValueExtractors\\c2.Cell shape.key");
