...
public class VitaminExtractorTest {
	...
	public static void main(String[] args){
		...
		*/
		...
		String lineFile = "F:/MicroPIE/micropieInput/sentences/3.14 Vitamin.txt";
		//STEP 1: split sentences
		List<RawSentence> testSentences = sentBatPIEProcessor.createSentencesByLine(lineFile);
		...
		extractor.readKeywords("F:\\MicroPIE\\micropieInput\\CharacterValueExtractors\\c30.Vitamins and Cofactors required for growth.key");
