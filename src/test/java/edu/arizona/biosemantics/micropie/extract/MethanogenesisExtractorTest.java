...
public class MethanogenesisExtractorTest {
	...
	public static void main(String[] args){
		...
		String lineFile = "C:/micropie/sentences/6.3 methanogenesis products.txt";
		...
		PhraseBasedExtractor extractor = new PhraseBasedExtractor(postagger, Label.c43, "c43.Methanogenesis products", null, null);
		extractor.setPhraseParser(phraseParser);
		extractor.readKeywords("C:\\micropie\\micropie0.2_model\\CharacterValueExtractors\\c43.Methanogenesis products.key");
		extractor.setMatchMode("W");
		PostProcessor postProcessor = new PostProcessor();
		for (RawSentence testSentence : testSentences) {
			Set prediction = new HashSet();
			prediction.add(Label.c43);
