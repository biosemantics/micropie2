...
public class AerophilicityExtractorTest {
	...
	public static void main(String[] args){
		...
		*/
		...
		StanfordParserWrapper stanfordWrapper = new StanfordParserWrapper(sfCoreNLP, lexParser, null);
		...
		String lineFile = "F:/MicroPIE/micropieInput/sentences/3.12 aerophilicity simple.txt";
		//STEP 1: split sentences
		List<RawSentence> testSentences = sentBatPIEProcessor.createSentencesByLine(lineFile);
		...
		KeywordBasedExtractor extractor = new KeywordBasedExtractor(Label.c28, "Aerophilicity",null,null);
		extractor.readKeywords("F:\\MicroPIE\\micropieInput\\CharacterValueExtractors\\c28.Aerophilicity.key");
		
		for (RawSentence testSentence : testSentences) {
			Set prediction = new HashSet();
			prediction.add(Label.c28);
