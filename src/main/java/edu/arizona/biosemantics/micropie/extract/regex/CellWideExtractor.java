...
public class CellWideExtractor extends AbstractCharacterValueExtractor {

	public CellWideExtractor(ILabel label) {
		super(label, "Cell Wide");
	}
	
	@Inject
	public CellWideExtractor(@Named("CellWideExtractor_Label")Label label, 
