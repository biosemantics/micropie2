...
public class CellLongExtractor extends AbstractCharacterValueExtractor {

	public CellLongExtractor(ILabel label) {
		super(label, "Cell Long");
	}
	
	@Inject
	public CellLongExtractor(@Named("CellLongExtractor_Label")Label label, 
