...
MicroPIE 0.2.0 has now been integrated into the ETC toolkit (<a href="http://etc.cs.umb.edu/etcsite/">etc.cs.umb.edu/etcsite</a>) and supports the Text Capture function for bacterial taxa. 
